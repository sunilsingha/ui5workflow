		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#changenamespaceworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"changenamespaceworkflowuimodule-display": {
								"semanticObject": "changenamespaceworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=changenamespace.workflowuimodule",
									"url": sap.ui.require.toUrl("changenamespace/workflowuimodule")
								}
							}
						}
					}
